...
class ImageProgect {
	...
	void Image() {
		...
		scene.setAmbientLight(new AmbientLight(new Color(WHITE), 0.15)).setBackground(new Color(173,216,230)); //.setSoftShadow(9).setDelta(15);
		...
		scene.geometries.add(
				...
				new Sphere(new Point(500,600,500),100d).setEmission(new Color(190,160,21)).setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(60)),//yellow: middle-up, middle-right 
		...
		scene.lights.add(new SpotLight(new Color(1020, 400, 400), new Point(900,950,500),new Vector(-1,-3,0)) //yellow sphere: up, right
				.setKl(4E-5).setKq(2E-7));
		scene.lights.add(new SpotLight(new Color(1020, 400, 400), new Point(0,0,5000),new Vector(0,0,-1)) //behind camera: front, direction to the picture
				.setKl(4E-5).setKq(2E-7));
